...
В директории docs находится [полноценный дизайн-документ](https://github.com/EgorMIt/HappyBirthdayBot/blob/master/docs/Рефакторинг_Дизайн-Документ.pdf) в формате .pdf и дополнительная информация
